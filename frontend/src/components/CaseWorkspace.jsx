      ...
      <div className="cw-tab-panel">
        <div className="cw-empty-inline">
          ...
          <p className="cw-empty-msg">
            Documents saved with "Draft" in their title or type will appear here. Use the LexAmplify to generate petitions, notices, or agreements.
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="cw-tab-panel">
        <div className="cw-empty-inline">
          ...
          <p className="cw-empty-msg">
            When you save a document to this folder via the LexAmplify, the full AI conversation that produced it is recorded here as a tamper-evident audit trail.
          </p>
        </div>
      </div>
    );
