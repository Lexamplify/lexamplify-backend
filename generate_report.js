  ...
  sections: [
    ...
    // ══════════════════════════════════════════════════════════════════════════
    {
      ...
      children: [
        ...
        new Table({
          ...
          rows: [
            ...
            moduleRow('📊', 'Dashboard', '/dashboard',
              ...
              'Complete', C.green, C.greenPale, false),
            moduleRow('💬', 'LexAmplify', '⌘K global overlay',
            ...
            moduleRow('⚔️', 'Virtual Courtroom', '/war-room',
              '5-stage animated pipeline loader. Live Indian Kanoon precedent search. AI-drafted strategic opening argument. Red-team opposing counsel simulation. Results: Issues cards, Arguments panel, Rebuttal cards, Precedents rail. Export to Vault. Triggered from direct route or via LLM intent from LexAmplify.',
              'Complete', C.green, C.greenPale, false),
        ...
        checkItem('✓', 'Courtroom simulation trigger from LexAmplify', C.green),
        ...
        new Table({
          ...
          rows: [
            ...
            gapRow('09', 'LexAmplify', 'Inline citation hyperlinks — when the LLM cites a judgment, the text should be a clickable link to Indian Kanoon rather than plain text. Builds verifiability and trust.', 'P2 High', C.amber, C.amberPale, false),
